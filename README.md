...
* [fig_05.ipynb](Code/Plotting/fig_05.ipynb)
...
* Biweekly simulations: 
    * Simulations launched from .sh files : [Particle_AZO_grid_Jul_w01_biweekly_hourly_BACK_v02.sh](Code/Calculations/Simulations/Biweekly/Particle_AZO_grid_Jul_w01_biweekly_hourly_BACK_v02.sh), which call the function: [parcels_azores_eNATL60_v02.py](Code/Calculations/Simulations/Biweekly/parcels_azores_eNATL60_v02.py)
    * Input(s): eNATL60 model surface u and v outputs. Data available upon request.
...
* Skewness: 2021-02-22_Azores_simus_100000p_hists_MONTHLY_allMONTHS_subregion_v02_SKEWNESS.ipynb
 	...
 	* Output(s): [skew_2D_months_subregion_v02.npz](Code/Calculations/skew_2D_months_subregion_v02.npz)
